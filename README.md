...
|Name|Last Updated|Problem 1, Test 1|Problem 2, Test 1|Problem 2, Test 2|Total Correct|
|---|---|---|---|---|---|
|Donald "The DJ" Pinckney|1:18:40 pm,<br />Jul 2|*Didn't compile* :warning:<br /> 0 seconds|*Timeout* :hourglass:<br /> 5 seconds|**Correct** :+1:<br /> 4.03 seconds|1|
